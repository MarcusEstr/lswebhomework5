...
*/
for (var i = 1; i <= 100; i++) { //For 1 to 100...
		if (i % 15 === 0) { //If divisible by 15, print FizzBuzz.
			console.log("FizzBuzz");
		}
		else if (i % 3 === 0) { //If divisible by 3, print Buzz.
			console.log("Buzz");
		}
		else if (i % 5 === 0) { //If divisible by 5, print Fizz.
			console.log("Fizz");
		}
		else { //If not divisible by 5, 3, or 15, print the number.
			console.log(i);
		}
}